...
Gem::Specification.new do |s|
  ...
  s.homepage = "http://github.com/yong/stropheruby"
  s.date = %q{2010-09-19}
  s.email = ["flamontagne@gmail.com", "xue.yong.zhi@gmail.com", "yedingding@gmail.com"]
  ...
  s.description = %q{Stropheruby is a ruby bindings for Strophe, a C library for writing XMPP clients.}
